...
const UpgradePanel = ({ upgrades }: UpgradePanelProps) => {
  return (
    <div className="flex justify-around items-center w-full rounded-md border-2 border-black bg-[#1B2947] p-4 font-bold text-white shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
